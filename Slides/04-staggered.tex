%% 04-staggered.tex — Codechella Madrid Day 4: Bacon decomposition + Callaway-Sant'Anna
%% Scott Cunningham, University of Glasgow, May 21, 2026
%%
%% Compile: pdflatex 04-staggered.tex
...
\begin{center}
\includegraphics[width=0.76\textwidth,height=0.6\textheight,keepaspectratio]{figures/bacon_sw_sampling_dist.pdf}
\end{center}
\vspace{-0.4em}
\begin{center}
\textbf{PT works} \;{\small(every 2$\times$2 is a real ATT)} \;$\cdot$\; \highlight{Heterogeneity kills} \;{\small(forbidden 2$\times$2 picks up $-\Delta\text{ATT}_k$)}
\end{center}
\end{frame}
...
\end{enumerate}
\vspace{0.3em}
\meta{Walkthrough: \texttt{glasgow/labs/Brazil/README.md}. \;Reference code: \texttt{labs/Brazil/code/brazil.do} and \texttt{brazil.R}. \;Data on Scott's GitHub: \texttt{mixtape/brazil.dta}.}
\end{frame}
...
{\small\color{warmgray} Scott Cunningham \textperiodcentered\ CUNEF Auditorium \textperiodcentered\ May 25--28, 2026}
\end{frame}
